...
DM_Rad_axs[0].semilogx(x_axis,fire_DMvsR[M_chosen[1],:]-mean_DM,'-', label= 'FIRE',lw=5,color='green')
DM_Rad_axs[0].semilogx(x_axis,P_DMvsR[M_chosen[1],:]-mean_DM,'-' ,label= 'Precipitation',lw=5,color='c')
DM_Rad_axs[0].semilogx(x_axis,NFW_DMvsR[M_chosen[1],:]-mean_DM,'-' ,label= 'NFW',lw=5,color='blue')
DM_Rad_axs[0].semilogx(x_axis,STH_DMvsR[M_chosen[1],:]-mean_DM,'-', label= '3D Tophat',lw=5,color= 'red')
DM_Rad_axs[0].semilogx(x_axis,STH_2_DMvsR[M_chosen[1],:]-mean_DM,'-', label= '3D Tophat 2$R_{vir}$',lw=5,color= 'orange')


# Masks
DM_Rad_axs[0].semilogx(x_axis,STH_masks[M_chosen[1],:],'--', lw=2,color='red')
DM_Rad_axs[0].semilogx(x_axis,STH_2_masks[M_chosen[1],:],'--', lw=2,color='orange')
DM_Rad_axs[0].semilogx(x_axis,fire_masks[M_chosen[1],:],'--',lw=2,color='green')
DM_Rad_axs[0].semilogx(x_axis,NFW_masks[M_chosen[1],:],'--', lw=2,color='blue')
DM_Rad_axs[0].semilogx(x_axis,P_masks[M_chosen[1],:],'--', lw=2,color='c')
...
DM_Rad_axs[1].semilogx(x_axis,fire_DMvsR[M_chosen[2],:]-mean_DM,'-' ,label= 'fire',lw=5,color='green')
DM_Rad_axs[1].semilogx(x_axis,P_DMvsR[M_chosen[2],:]-mean_DM,'-' ,label= 'Precipitation',lw=5,color='c')
DM_Rad_axs[1].semilogx(x_axis,NFW_DMvsR[M_chosen[2],:]-mean_DM,'-', label= 'NFW',lw=5,color='blue')
DM_Rad_axs[1].semilogx(x_axis,STH_DMvsR[M_chosen[2],:]-mean_DM,'-', label= '3D tophat',lw=5,color='red')
DM_Rad_axs[1].semilogx(x_axis,STH_2_DMvsR[M_chosen[2],:]-mean_DM,'-', label= '3D tophat',lw=5,color='orange')

# Masks
DM_Rad_axs[1].semilogx(x_axis,STH_masks[M_chosen[2],:],'--', lw=1.5,color='red')
DM_Rad_axs[1].semilogx(x_axis,STH_2_masks[M_chosen[2],:],'--', lw=1.5,color='orange')
DM_Rad_axs[1].semilogx(x_axis,fire_masks[M_chosen[2],:],'--',lw=1.5,color='green')
DM_Rad_axs[1].semilogx(x_axis,NFW_masks[M_chosen[2],:],'--', lw=1.5,color='blue')
DM_Rad_axs[1].semilogx(x_axis,P_masks[M_chosen[2],:],'--', lw=2,color='c')
...
# Third plot
DM_Rad_axs[2].semilogx(x_axis,fire_DMvsR[M_chosen[3],:]-mean_DM,'-', label= 'Fire',lw=5,color='green')
DM_Rad_axs[2].semilogx(x_axis,P_DMvsR[M_chosen[3],:]-mean_DM,'-' ,label= 'Precipitation',lw=5,color='c')
DM_Rad_axs[2].semilogx(x_axis,NFW_DMvsR[M_chosen[3],:]-mean_DM, '-',label= 'NFW',lw=5,color='blue')
DM_Rad_axs[2].semilogx(x_axis,STH_DMvsR[M_chosen[3],:]-mean_DM,'-', label= '3D tophat',lw=5,color='red')
DM_Rad_axs[2].semilogx(x_axis,STH_2_DMvsR[M_chosen[3],:]-mean_DM,'-', label= '3D tophat',lw=5,color='orange')

DM_Rad_axs[2].semilogx(x_axis,STH_masks[M_chosen[3],:],'--', lw=2,color='red')
DM_Rad_axs[2].semilogx(x_axis,STH_2_masks[M_chosen[3],:],'--', lw=2,color='orange')
DM_Rad_axs[2].semilogx(x_axis,fire_masks[M_chosen[3],:],'--',lw=2,color='green')
DM_Rad_axs[2].semilogx(x_axis,NFW_masks[M_chosen[3],:], '--',lw=2,color='blue')
DM_Rad_axs[2].semilogx(x_axis,P_masks[M_chosen[3],:],'--', lw=2,color='c')
